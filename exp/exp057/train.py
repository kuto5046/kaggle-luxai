...
def main():
    ...
    # fix param
    # for param in model.policy.features_extractor.inc.parameters():
    #     param.requires_grad = False
    # for param in model.policy.features_extractor.down1.parameters():
    #     param.requires_grad = False
    # for param in model.policy.features_extractor.down2.parameters():
    #     param.requires_grad = False
    # for param in model.policy.features_extractor.down3.parameters():
    #     param.requires_grad = False
